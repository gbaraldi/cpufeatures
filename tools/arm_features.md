...
Total: 412 features, 376 detectable, 24 removed.

| Feature Name             | Optional | Mandatory | LLVM         | sysregs | Short description
| ------------------------ | -------- | --------- | ------------ | :-----: | -----------------
...
| FEAT_AA64                | Armv8.0  |           |              |    X    | PE uses AArch64 after last reboot
...
| FEAT_BBML3               | Armv8.3  | Armv8.3   |              |    X    | Translation table break-before-make level 3
| FEAT_BF16                | Armv8.2  | Armv8.6   | bf16         |    X    | AARch64 BFloat16 instructions
| FEAT_BigEnd              | Armv8.0  |           |              |    X    | Support for big-endian at EL1 and above
| FEAT_BigEndEL0           | Armv8.0  |           |              |    X    | Support for big-endian at EL0
| FEAT_BRBE                | Armv9.1  |           |              |    X    | Branch Record Buffer Extensions
| FEAT_BRBEv1p1            | Armv9.2  |           |              |    X    | Branch Record Buffer Extensions version 1.1
| FEAT_BTI                 | Armv8.4  | Armv8.5   | bti          |    X    | Branch target identification
| FEAT_BTIE                | Armv9.6  |           |              |    X    | Enhanced Branch Target Identification
...
| FEAT_CHK                 | Armv8.0  | Armv9.4   | chk          |   n/a   | CHKFEAT instruction, detect when certain features are enabled
| FEAT_CLRBHB              | Armv8.0  | Armv8.9   | clrbhb       |    X    | Support for Clear Branch History instruction
| FEAT_CMH                 | Armv9.0  |           |              |    X    | Contention Management Hints
...
| FEAT_CSSC                | Armv8.7  | Armv8.9   | cssc         |    X    | Common Short Sequence Compression scalar integer instructions
...
| FEAT_DIT                 | Armv8.3  | Armv8.4   | dit          |    X    | Data Independent Timing instructions
| FEAT_DoPD                | Armv8.2  |           |              |   n/a   | Debug over Powerdown
| FEAT_DotProd             | Armv8.1  |           | dotprod      |    X    | Advanced SIMD Int8 dot product instructions
...
| FEAT_DPB                 | Armv8.1  | Armv8.2   | ccpp         |    X    | DC CVAP instruction
| FEAT_DPB2                | Armv8.1  | Armv8.5   | ccdp         |    X    | DC CVADP instruction
...
| FEAT_EAESR               | Armv9.0  | Armv9.7   |              |    X    | Enable Abort Exception System Registers
...
| FEAT_ECV                 | Armv8.5  | Armv8.6   | ecv          |    X    | Enhanced counter virtualization
...
| FEAT_EVT2                | Armv8.2  |           |              |    X    | Enhanced Virtualization Traps 2
| FEAT_ExS                 | Armv8.4  |           |              |    X    | Disabling context synchronizing exception entry and exit
| FEAT_F16F32DOT           | Armv9.4  |           |              |    X    | Advanced SIMD half-precision to single-precision dot product
| FEAT_F16F32MM            | Armv9.4  |           |              |    X    | Advanced SIMD half-precision to single-precision matrix multiply-accumulate
| FEAT_F16MM               | Armv9.6  |           |              |    X    | Half-precision floating-point matrix multiply-accumulate
| FEAT_F32MM               | Armv8.2  |           | f32mm        |    X    | SVE single-precision floating-point matrix multiply instruction
| FEAT_F64MM               | Armv8.2  |           | f64mm        |    X    | SVE double-precision floating-point matrix multiply instruction
| FEAT_F8F16MM             | Armv9.2  |           | f8f16mm      |    X    | FP8 to Half-Precision Matrix Multiplication
| FEAT_F8F32MM             | Armv9.2  |           | f8f32mm      |    X    | FP8 to Single-Precision Matrix Multiplication
| FEAT_FAMINMAX            | Armv9.2  |           | faminmax     |    X    | Advanced SIMD, SVE2, and SME2 FAMIN and FAMAX instructions
| FEAT_FCMA                | Armv8.2  |           | complxnum    |    X    | Floating-point FCMLA and FCADD instructions
| FEAT_FDIT                | Armv9.4  | Armv9.7   |              |    X    | Force Data Independent Timing
...
| FEAT_FHM                 | Armv8.1  |           | fp16fml      |    X    | Half-precision floating-point FMLAL instructions
| FEAT_FlagM               | Armv8.1  | Armv8.4   | flagm        |    X    | Condition flag manipulation
| FEAT_FlagM2              | Armv8.4  |           | altnzcv      |    X    | Condition flag manipulation version 2
| FEAT_FP                  | Armv8.0  |           |              |    X    | Floating point extension
| FEAT_FP16                | Armv8.2  |           | fullfp16     |    X    | Half-precision floating-point data processing
| FEAT_FP8                 | Armv9.2  |           | fp8          |    X    | FP8 convert instructions
| FEAT_FP8DOT2             | Armv9.2  |           | fp8dot2      |    X    | FP8 to half-precision 2-way dot product
| FEAT_FP8DOT4             | Armv9.2  |           | fp8dot4      |    X    | FP8 to single-precision 4-way dot product
| FEAT_FP8FMA              | Armv9.2  |           | fp8fma       |    X    | FP8 multiply-accumulate instructions
| FEAT_FPAC                | Armv8.2  |           | fpac         |    X    | Faulting on pointer authentication instructions
...
| FEAT_FPRCVT              | Armv9.5  | Armv9.6   | fprcvt       |    X    | Floating-Point to/from Integer in Scalar FP register
| FEAT_FRINTTS             | Armv8.4  |           | fptoint      |    X    | FRINT32Z, FRINT32X, FRINT64Z, and FRINT64X instructions
| FEAT_GCIE                | Armv9.3  |           |              |    X    | GICv5 CPU interface extension
| FEAT_GCIE_LEGACY         | Armv9.3  |           |              |   n/a   | GICv5 CPU interface extension to support GICv3.3 VMs
| FEAT_GCS                 | Armv9.3  |           | gcs          |    X    | Guarded Control Stack Extension
...
| FEAT_HBC                 | Armv8.7  | Armv8.8   | hbc          |    X    | Hinted conditional branches
...
| FEAT_I8MM                | Armv8.1  | Armv8.6   | i8mm         |    X    | Int8 Matrix Multiplication
...
| FEAT_JSCVT               | Armv8.2  |           | jsconv       |    X    | JavaScript FJCVTS conversion instruction
| FEAT_LittleEnd           | Armv8.0  |           |              |    X    | Support for little-endian at EL1 and above
| FEAT_LittleEndEL0        | Armv8.0  |           |              |    X    | Support for little-endian at EL0
| FEAT_LOR                 | Armv8.0  | Armv8.1   | lor          |    X    | Limited ordering regions
| FEAT_LORRL               | Armv9.3  |           |              |   n/a   | Limited Order Regions in Realm PA space
...
| FEAT_LRCPC               | Armv8.2  | Armv8.3   | rcpc         |    X    | Load-acquire RCpc instructions
| FEAT_LRCPC2              | Armv8.2  | Armv8.4   | rcpc-immo    |    X    | Load-acquire RCpc instructions version 2
| FEAT_LRCPC3              | Armv8.2  |           | rcpc3        |    X    | Load-Acquire RCpc instructions version 3
| FEAT_LS64                | Armv8.6  |           | ls64         |    X    | Support for 64 byte loads/stores without return
...
| FEAT_LSCP                | Armv9.3  |           |              |    X    | Load and Store Consistency Pair instructions
| FEAT_LSE                 | Armv8.0  | Armv8.1   | lse          |    X    | Large System Extensions
| FEAT_LSE128              | Armv9.3  |           | lse128       |    X    | 128-bit Atomics
| FEAT_LSE2                | Armv8.2  | Armv8.4   | lse2         |    X    | Large System Extensions version 2
| FEAT_LSFE                | Armv9.3  |           | lsfe         |    X    | Large System Float Extension
...
| FEAT_LUT                 | Armv9.2  |           | lut          |    X    | Lookup table instructions with 2-bit and 4-bit indices
...
| FEAT_MOPS                | Armv8.7  | Armv8.8   | mops         |    X    | Standardization of memory operations
| FEAT_MOPS_GO             |          |           |              |    X    | Standardization of memory operations, tag only
...
| FEAT_MPAMv2              | Armv9.4  |           |              |    X    | Memory System Resource Partitioning and Monitoring extension version 2.0
| FEAT_MPAMv2_ALT_ID       | Armv9.4  |           |              |    X    | MPAM 2.0 Alternative IDs
| FEAT_MPAMv2_MSC          | Armv9.4  |           |              |   n/a   | MPAM 2.0 Memory System Compnents
| FEAT_MPAMv2_MSC_MON_SEC  | Armv9.4  |           |              |   n/a   | MPAM 2.0 for MSC resource monitors, monitor instance assignment to PA space
| FEAT_MPAMv2_VID          | Armv9.4  |           |              |    X    | MPAM 2.0 Configuration Controls for Virtualization
| FEAT_MTE                 | Armv8.4  |           | mte          |    X    | Instruction-only Memory Tagging Extension
...
| FEAT_MTE_EIRG            | Armv9.4  |           |              |    X    | Enhanced Insert Random taG algorithm
...
| FEAT_MTEFGT              |          |           |              |    X    | MTE Fine grained traps
| FEAT_MTETC               | Armv9.6  |           |              |    X    | Tag cache store and zero instructions
...
| FEAT_NV3                 | Armv9.3  |           |              |    X    | Nested guest TGE control
| FEAT_OCCMO               | Armv9.3  | Armv9.6   |              |    X    | Outer Cacheable Cache Maintenance Operation
...
| FEAT_PAuth               | Armv8.2  | Armv8.3   | pauth        |    X    | Pointer authentication
| FEAT_PAuth2              | Armv8.2  | Armv8.6   |              |    X    | Enhancements to pointer authentication
| FEAT_PAuth_EnhCtl        | Armv9.6  | Armv9.7   |              |    X    | Enhanced controls for pointer authentication
...
| FEAT_RAS                 | Armv8.0  | Armv8.2   | ras          |    X    | Reliability, Availability, and Serviceability (RAS) Extension
| FEAT_RASSA_ACR           |          |           |              |   n/a   | Access Control Register (removed)
| FEAT_RASSA_GRP           |          |           |              |   n/a   | RAS groups (removed)
| FEAT_RASSAv1             |          |           |              |   n/a   | RAS System Architecture version 1 (removed)
| FEAT_RASSAv1p1           | Armv8.2  |           |              |   n/a   | RAS System Architecture version 1.1 (removed)
| FEAT_RASSAv2             | Armv8.8  |           |              |   n/a   | RAS System Architecture Extension v2 (removed)
...
| FEAT_RDM                 | Armv8.0  |           | rdm          |    X    | Rounding double multiply accumulate
...
| FEAT_RNG                 | Armv8.4  |           | rand         |    X    | Random number generator
...
| FEAT_S1POE2              |          |           |              |    X    | Stage 1 permission overlays 2
...
| FEAT_SB                  | Armv8.0  | Armv8.5   | sb           |    X    | Speculation barrier
| FEAT_SCR2                | Armv9.3  |           |              |    X    | Extension to SCR_EL3
...
| FEAT_SHA3                | Armv8.1  |           | sha3         |    X    | Advanced SIMD EOR3, RAX1, XAR, and BCAX instructions
| FEAT_SHA512              | Armv8.1  |           |              |    X    | Advanced SIMD SHA512 instructions
| FEAT_SM3                 | Armv8.1  |           |              |    X    | Advanced SIMD SM3 instructions
| FEAT_SM4                 | Armv8.1  |           | sm4          |    X    | Advanced SIMD SM4 instructions
| FEAT_SME                 | Armv9.2  |           | sme          |    X    | Scalable Matrix Extension
| FEAT_SME2                | Armv9.2  |           | sme2         |    X    | Scalable Matrix Extension version 2
| FEAT_SME2p1              | Armv9.2  |           | sme2p1       |    X    | Scalable Matrix Extension version 2.1
| FEAT_SME2p2              | Armv9.5  |           | sme2p2       |    X    | Scalable Matrix Extension version 2.2
| FEAT_SME2p3              | Armv9.6  |           |              |    X    | Scalable Matrix Extension version 2.3
| FEAT_SME_B16B16          | Armv9.2  |           | sme-b16b16   |    X    | Non-widening BFloat16 to BFloat16 arithmetic for SME2.1
| FEAT_SME_F16F16          | Armv9.2  |           | sme-f16f16   |    X    | Non-widening half-precision FP16 to FP16 arithmetic for SME2.1
| FEAT_SME_F64F64          | Armv9.2  |           | sme-f64f64   |    X    | Additional instructions for the SME Extension
| FEAT_SME_F8F16           | Armv9.2  |           | sme-f8f16    |    X    | SME2 ZA-targeting FP8 multiply-accumulate, dot product, and outer product to half-precision inst
| FEAT_SME_F8F32           | Armv9.2  |           | sme-f8f32    |    X    | SME2 ZA-targeting FP8 multiply-accumulate, dot product, and outer product to single-precision inst
| FEAT_SME_FA64            | Armv9.2  |           | sme-fa64     |    X    | Additional instructions for the SME Extension
| FEAT_SME_I16I64          | Armv9.2  |           | sme-i16i64   |    X    | Additional instructions for the SME Extension
| FEAT_SME_LUTv2           | Armv9.2  |           | sme-lutv2    |    X    | Lookup table instructions with 4-bit indices and 8-bit elements
| FEAT_SME_MOP4            | Armv9.4  |           | sme-mop4     |    X    | Quarter-tile outer product instructions
| FEAT_SME_TMOP            | Armv9.4  |           | sme-tmop     |    X    | Structured sparsity outer product instructions
...
| FEAT_SPE_ArchInst        |          |           |              |    X    | Statistical Profiling architectural instruction sampling
...
| FEAT_SPE_ERnd            |          |           |              |    X    | Statistical Profiling random sampling at end of period
...
| FEAT_SPE_LDS             |          |           |              |    X    | Statistical Profiling data source packet generation
...
| FEAT_SRMASK2             | Armv9.6  |           |              |    X    | Bitwise Write Masks for Hypervisor Configuration Registers
| FEAT_SSBS                | Armv8.0  |           |              |    X    | Speculative Store Bypass Safe Instruction
| FEAT_SSBS2               | Armv8.0  |           |              |    X    | MRS and MSR instructions for SSBS
| FEAT_SSVE_AES            | Armv9.5  |           | ssve-aes     |    X    | Streaming SVE Mode AES and 128-bit polynomial multiply long instructions
| FEAT_SSVE_BitPerm        | Armv9.4  |           | ssve-bitperm |    X    | Streaming Scalable Vector Bit Permutes instructions
...
| FEAT_SSVE_FEXPA          | Armv9.4  |           | ssve-fexpa   |    X    | Streaming FEXPA instruction
| FEAT_SSVE_FP8DOT2        | Armv9.2  |           | ssve-fp8dot2 |    X    | SVE FP8 2-way dot product to half-precision inst in Streaming SVE
| FEAT_SSVE_FP8DOT4        | Armv9.2  |           | ssve-fp8dot4 |    X    | SVE2 FP8 4-way dot product to single-precision inst in Streaming SVE
| FEAT_SSVE_FP8FMA         | Armv9.2  |           | ssve-fp8fma  |    X    | SVE2 FP8 multiply-accumulate to half-precision and single-precision inst in Streaming SVE
| FEAT_STEP2               | Armv9.4  | Armv9.5   |              |    X    | Enhanced Software Step Extension
| FEAT_SVE                 | Armv8.2  |           | sve          |    X    | Scalable Vector Extension
| FEAT_SVE2                | Armv9.0  |           | sve2         |    X    | SVE version 2
| FEAT_SVE2p1              | Armv9.2  |           | sve2p1       |    X    | Scalable Vector Extension version 2.1
| FEAT_SVE2p2              | Armv9.5  |           | sve2p2       |    X    | Scalable Vector Extensions version 2.2
| FEAT_SVE2p3              | Armv9.6  |           |              |    X    | Scalable Vector Extensions version 2.3
| FEAT_SVE_AES             | Armv9.0  |           | sve-aes      |    X    | SVE AES instructions
| FEAT_SVE_AES2            | Armv9.5  |           |              |    X    | SVE multi-vector AES and 128-bit polynomial multiply long instructions
| FEAT_SVE_B16B16          | Armv9.2  |           | sve-b16b16   |    X    | Non-widening BFloat16 to BFloat16 arithmetic for SVE2.1
| FEAT_SVE_B16MM           | Armv9.6  |           |              |    X    | SVE BFloat16 matrix multiply-accumulate
| FEAT_SVE_BFSCALE         | Armv9.2  |           |              |    X    | BFloat16 Floating-Point Adjust Exponent
| FEAT_SVE_BitPerm         | Armv9.0  |           | sve-bitperm  |    X    | SVE Bit Permute
| FEAT_SVE_F16F32MM        | Armv9.2  |           | sve-f16f32mm |    X    | SVE Half-Precision to Single-Precision Matrix Multiplication
| FEAT_SVE_PMULL128        | Armv9.0  |           |              |    X    | SVE PMULL instructions
| FEAT_SVE_SHA3            | Armv9.0  |           | sve-sha3     |    X    | SVE SHA-3 instructions
| FEAT_SVE_SM4             | Armv9.0  |           | sve-sm4      |    X    | SVE SM4 instructions
...
| FEAT_TEV                 |          |           |              |    X    | Exception-like overlay management mechanism
...
| FEAT_TLBID               | Armv9.3  |           |              |    X    | TLBI Domains
...
| FEAT_TPS                 |          |           |              |    X    | Thread Private State checking at EL0
| FEAT_TPSP                |          |           |              |    X    | Thread Private State checking at EL1 and EL2
...
| FEAT_VMTE                |          |           |              |    X    | Virtual Memory Tagging Extension
| FEAT_VMTEE               |          |           |              |    X    | Virtual Memory Tagging Extension Enables
| FEAT_VMTETC              |          |           |              |    X    | Virtual Memory Tagging Extension Tag Checking
| FEAT_VMTETCE             |          |           |              |    X    | Virtual Memory Tagging Extension Tag Checking Enables
| FEAT_VMTETCL             |          |           |              |    X    | Virtual Memory Tagging Extension Tag Checking Loads
| FEAT_VPIPT               | Armv8.2  |           |              |    X    | VMID-aware PIPT instruction cache (removed)
| FEAT_WFxT                | Armv8.6  | Armv8.7   | wfxt         |    X    | WFE and WFI instructions with timeout
